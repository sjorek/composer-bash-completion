                        ...
                        $options = explode(
                            ...
                            implode(
                                ...
                                explode(
                                    ...
                                    'application asgard-module asgard-theme behat-extension bundle cakephp-plugin claroline-plugin component composer composer-installer composer-plugin concrete5-package contao-bundle contao-component contao-module craft-plugin drupal-custom-module drupal-drush drupal-library drupal-module drupal-profile drupal-theme elgg-plugin ewma-module extension ezplatform-bundle ezpublish-legacy-extension flarum-extension framework fuel-package kirby-plugin kohana-module l laravel laravel-library laravel-module laravel-package lib libary library lithium-library magento-module magento2-language magento2-module magento2-theme mautic-plugin mediawiki-extension metapackage module mouf-library myadmin-plugin neos-package neos-plugin october-plugin oxideshop-module package php phpbb-extension phpcodesniffer-standard phpstan-extension pimcore-bundle pimcore-plugin plugin prestashop-module project psalm-plugin robo-tasks roundcube-plugin sallycms-addon sdk shopware-platform-plugin shopware-plugin silverstripe-module silverstripe-theme silverstripe-vendormodule simplesamlphp-module statamic-addon streams-addon sulu-bundle sylius-plugin symfony-bundle symfony1-plugin tao-extension template thelia-module think-extend typo3-cms-extension typo3-flow-package utility virtual-package winter-plugin wordpress-muplugin wordpress-plugin wordpress-theme wp-cli-package yii-extension yii2-extension yii2-module zf-module '
                                )
                            )
                        );
                        break;
